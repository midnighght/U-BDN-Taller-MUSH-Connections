    ...
    <div className="min-h-screen bg-[#fff8f5] flex flex-col">
      ...
      <main className="flex flex-1 mt-4 px-8 space-x-8 max-w-7xl mx-auto w-full">
        ...
        <aside className="w-1/5">
          <h2 className="text-2xl font-bold mb-6 text-gray-800">Comunidades</h2>
          {[1, 2].map((i) => (
            <div key={i} className="flex items-center mb-6">
              ...
              <div className="ml-3">
                <p className="font-semibold text-gray-800 text-sm">Nombre de Comunidad</p>
                <div className="flex space-x-2 mt-1">
                  <button className="bg-orange-500 text-white text-xs px-3 py-1 rounded">Página</button>
                  <button className="bg-red-500 text-white text-xs px-3 py-1 rounded">Miembros</button>
                </div>
              </div>
            </div>
          ))}
          ...
          {[1, 2].map((post) => (
            <div key={post} className="bg-white rounded-3xl shadow p-5">
              ...
              <div className="flex items-center mb-3">
                ...
                <span className="ml-3 font-semibold text-gray-800 text-lg">Nombre de Usuario</span>
              </div>
                ...
                {[1, 2, 3].map((c) => (
                  <div key={c} className="flex items-start mb-3">
                    ...
                    <div className="ml-2 text-sm">
                      <p className="font-semibold text-gray-700">Nombre de Usuario</p>
        ...
        <aside className="w-1/5">
          ...
          {[1, 2, 3].map((a) => (
            <div key={a} className="flex items-center mb-4">
              ...
              <div className="ml-3">
                <p className="font-semibold text-gray-800 text-sm">Nombre de Usuario</p>
                <button className="bg-orange-500 text-white text-xs px-3 py-1 rounded">Perfil</button>
              </div>
            </div>
          ))}

          {/* Sugerencias */}
          <h2 className="text-2xl font-bold mt-8 mb-6 text-gray-800">Sugerencias</h2>
          {[1, 2].map((s) => (
            <div key={s} className="flex items-center mb-4">
              ...
              <div className="ml-3">
                ...
                <div className="flex space-x-2 mt-1">
                  <button className="bg-orange-500 text-white text-xs px-3 py-1 rounded">Perfil</button>
                  <button className="bg-red-500 text-white text-xs px-3 py-1 rounded">Seguir</button>
                </div>
              </div>
            </div>
          ))}
